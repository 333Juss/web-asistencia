...
public class LoginResponseDto {
    ...
    public static LoginResponseDto fromUsuario(Usuario usuario, String token) {
        ...
        if (usuario.getColaborador() != null) {
            ...
            // Construir DTO de la sede si existe
            SedeDto sedeDto = null;
            if (colab.getSede() != null) {
                sedeDto = SedeDto.builder()
                        .id(colab.getSede().getId())
                        .codigo(colab.getSede().getCodigo())
                        .nombre(colab.getSede().getNombre())
                        .direccion(colab.getSede().getDireccion())
                        .distrito(colab.getSede().getDistrito())
                        .provincia(colab.getSede().getProvincia())
                        .departamento(colab.getSede().getDepartamento())
                        .latitud(colab.getSede().getLatitud())
                        .longitud(colab.getSede().getLongitud())
                        .radioMetros(colab.getSede().getRadioMetros())
                        .activo(colab.getSede().getActivo())
                        .build();
            }
