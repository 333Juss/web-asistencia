    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Endpoints de administración (ADMIN, RRHH, SUPERVISOR)
                        .requestMatchers("/api/empresas/**", "/api/sedes/**", "/api/colaboradores/**",
                                "/api/reports/**", "/api/dashboard/**", "/api/configuracion/**")
                        .hasAnyRole("ADMIN", "RRHH", "SUPERVISOR")

                        // Endpoints de empleados
                        .requestMatchers("/api/asistencias/entrada", "/api/asistencias/salida",
                                "/api/biometria/capturar-rostro")
