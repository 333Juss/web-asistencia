...
export class ColaboradorService {
    ...
    toggleColaboradorStatus(id: number, activo: boolean): Observable<ApiResponse<Colaborador>> {
        ...
        return this.http.patch<ApiResponse<Colaborador>>(`${this.apiUrl}/${id}/status`, {}, { params });
    }
    ...
    asignarTurno(colaboradorId: number, turnoId: number): Observable<ApiResponse<Colaborador>> {
      return this.http.put<ApiResponse<Colaborador>>(
        `${this.apiUrl}/${colaboradorId}/turno/${turnoId}`,
        {}
      );
    }

  // ASIGNACIÓN MASIVA DE TURNOS
  asignarTurnoMasivo(data: any): Observable<any> {
    return this.http.post(`${this.apiUrl}/asignar-turno-masivo`, data);
  }
}
